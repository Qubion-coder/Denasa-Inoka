      ...
      >
        ...
        <div className="lg:w-1/2 lg:pr-10 mb-12 lg:mb-0 relative text-center lg:text-left">
          ...
          <div className="mt-6 mb-8 text-[10px] sm:text-sm font-sans tracking-[0.15em] sm:tracking-[0.2em] uppercase font-semibold text-brand-plum drop-shadow-sm leading-loose">
            Please RSVP by October 30, 2026 <br/>
            0773895663 | 0771978638
          </div>
          ...
          <AnimatePresence mode="wait">
            {status === 'success' ? (
              ...
              >
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-[0.2em] font-bold text-stone-500 mb-3 ml-2">Notes (Optional)</label>
                  <textarea
